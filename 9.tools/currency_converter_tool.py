...
def get_conversion_factor(base_currency: str, target_currency: str) -> float:
    ...
    """
    url = f"https://v6.exchangerate-api.com/v6/<enter-api-key-before-use>/pair/{base_currency}/{target_currency}"
...
llm_with_tools = gemini.bind_tools([get_conversion_factor, convert])
